...
const newHtml = `        canvaRenderLayer.innerHTML = \`<div class="cvr-base" style="width:100%;height:100%;position:relative;overflow:hidden;background:#450a0a;font-family:Cinzel,serif;">
    ...
    <div style="position:absolute;bottom:\${scaleY(40)}px;left:\${scaleX(80)}px;text-align:left;font-size:\${scaleMin(30)}px;color:#ffffff;font-family:sans-serif;font-weight:800;letter-spacing:2px;z-index:20;text-shadow:0 2px 5px rgba(0,0,0,0.8);">
        <span class="editable-text" style="display:inline-block;min-width:50px;">\${contact}</span>
    </div>
    
    <div style="position:absolute;bottom:\${scaleY(40)}px;left:0;width:100%;text-align:center;">
    ...
    <div style="position:absolute;bottom:\${scaleY(40)}px;right:\${scaleX(80)}px;text-align:right;display:flex;flex-direction:column;align-items:flex-end;">
        <div style="font-size:\${scaleMin(30)}px;color:#fff;font-family:Lora,serif;letter-spacing:2px;line-height:1.4;"><span class="editable-text" style="display:inline-block;min-width:50px;white-space:pre-wrap;">\${feats}</span></div>
    </div>
</div>\`;`;
...
console.log('Fixed Klasik 1 Layout - Adjusted bottoms and font sizes.');
