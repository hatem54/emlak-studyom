...
// The original _kolaj10 function string (we will replace the entire function to be safe)
const oldFunc = `function _kolaj10(){
    ...
    w.innerHTML = 
        ...
        _yazi(3, 3, 60, 8,
            '<div style="font-size:53px;font-weight:900;letter-spacing:8px;color:#c0c0c0;">EMLAK</div>', {padding:'0', extra:'z-index:2;'})+
        _yazi(63, 3, 34, 8,
        ...
        _yazi(3, 82, 79, 16,
            ...
            '<div style="font-size:95px;font-weight:900;line-height:1;">'+_b('baslik','Elmas Rezidans')+'</div>'+
...
const newFunc = `function _kolaj10(){
    ...
    w.innerHTML = 
        ...
        _yazi(3, 76, 76, 24,
            ...
            '<div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:5px;border-top:1px solid #c0c0c0;padding-top:10px;">'+
            '<div style="font-size:30px;opacity:0.8;">'+_b('ozellik1','5+2')+' • '+_b('ozellik2','400 m²')+' • '+_b('ozellik3','Havuzlu')+'</div>'+
            '<div style="font-size:56px;font-weight:900;color:#c0c0c0;">'+_b('fiyat','55.000.000 TL')+'</div></div></div>', {padding:'0', extra:'z-index:2;'});
    c.appendChild(w);
}`;
...
if(c.includes(oldFunc)) {
    ...
    console.log('Successfully updated Kolaj 10 template');
} else {
