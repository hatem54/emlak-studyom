...
const replacement = `
          <div class="section-title">✨ Genel Metin Stil</div>
          <div class="row-2" style="margin-bottom:10px;">
              <div class="color-row"><label>Yazı Rengi</label><input type="color" id="globalTextColor" value="#ffffff" oninput="if(typeof applyFontSettings === 'function') applyFontSettings()"></div>
              <div class="color-row"><label>Arka Plan</label>
...
html = html.replace(/<div class="section-title">✨ Genel Metin Stil<\/div>\s*<div class="row-2">/, replacement.trim() + "\n");
