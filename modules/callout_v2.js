...
window.addParcelBadgeToCanvas = function(parcelData, options = {}) {
    ...
    if (options.customColors) {
        ...
        themeConfig = {
            ...
            bgOp: op,
            border: options.customColors.borderColor || themeConfig.border,
            borderWidth: options.customColors.borderWidth !== undefined ? options.customColors.borderWidth : themeConfig.borderWidth,
            title: options.customColors.titleColor || themeConfig.title,
            sub: options.customColors.subColor || themeConfig.sub,
            icon: options.customColors.borderColor || options.customColors.subColor || themeConfig.icon
        };
    }
