...
function _kurumsalInit(){
    ...
    container.innerHTML = `
        ...
        <div class="input-group"><label>Marka / İletişim</label><input type="text" id="canvaKContact" value="EMLAK STUDYOM | 0532 000 0000"></div>
...
function buildKCards(){
    ...
    if(!grid) {
        ...
        const cont = document.getElementById('tpl-content-kurumsal'); if(cont) cont.insertBefore(grid, cont.firstChild);
    }
    grid.innerHTML = '';
