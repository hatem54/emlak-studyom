...
function _ozelInit(){
    ...
    container.innerHTML = `
        ...
        <div class="input-group"><label>Marka / İletişim</label><input type="text" id="canvaOContact" value="EMLAK STUDYOM | 0532 000 0000"></div>
