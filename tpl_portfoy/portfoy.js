...
function renderPTemplate(id){
    ...
    if (id === 'canvaP1') {
        ...
        canvaRenderLayer.innerHTML = `<div class="cvr-base" style="width:100%;height:100%;position:relative;overflow:hidden;background:#166534;font-family:Raleway,sans-serif;">
