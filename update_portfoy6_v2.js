...
for(let i=0; i<canvaLines.length; i++) {
    if(canvaLines[i].includes("canvaRenderLayer.innerHTML = `") && canvaLines[i-1].includes("if (id === 'canvaP6') {")) {
        sIdx = i;
        break;
    }
}
...
if(sIdx !== -1) {
    ...
    let newHtml = `        canvaRenderLayer.innerHTML = \`<div class="cvr-base" style="width:100%;height:100%;position:relative;overflow:hidden;background:#166534;font-family:Raleway,sans-serif;">
    ...
    console.log('Portfoy 6 updated successfully via array splice.');
} else {
    console.log('Not found by line matching.');
}
